...
const { updating, increaseQuantity, decreaseQuantity, handleRemove } =
  useCartActions();
</script>

<template>
  <div
    class="rounded-none border-2 border-gray-100 bg-white p-6 shadow-sm transition-colors hover:border-gray-300"
  >
