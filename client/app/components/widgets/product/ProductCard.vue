...
<template>
  ...
  >
    <!-- Изображение товара -->
    <!-- <router-link
      :to="{ ...links.PRODUCT_DETAIL_LINK, params: { id: product.id } }"
    >
    ...
    <div class="p-4">
      ...
      >
        <h3
          class="mb-2 text-lg font-semibold text-black transition-colors hover:text-gray-700"
        >
          {{ product.name }}
        </h3>
      </router-link> -->
      ...
      <!-- Цена -->
      <p class="mb-4 text-2xl font-bold text-black">
